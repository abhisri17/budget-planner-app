    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {cashFlowData.length > 10 && (
        <div className="mt-4 text-center">
          ...
          >
            {showAllYears
              ? "Show Less"
              : `Show All ${cashFlowData.length} Years`}
          </button>
        </div>
      )}
      ...
      <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-400">
        <p className="text-sm text-blue-800">
          <strong>💡 Recurring Goals:</strong> Goals marked with 🔄 repeat at
          specified intervals. Each occurrence is inflation-adjusted and
          deducted from your wealth when due.
        </p>
      </div>
    </div>
  );
